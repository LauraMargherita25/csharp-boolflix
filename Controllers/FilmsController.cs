...
namespace csharp_boolflix.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Plot,ReleaseDate,RunningTime")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Plot,ReleaseDate,RunningTime")] Film film)
        {
            if (id != film.Id)
            {
                return NotFound();
