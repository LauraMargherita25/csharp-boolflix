...
namespace csharp_boolflix.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ChildProfile")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ChildProfile")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
